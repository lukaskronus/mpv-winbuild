...
[![GitHub Workflow Status](https://img.shields.io/github/actions/workflow/status/lukaskronus/mpv-winbuild/mpv.yml?branch=main)](https://github.com/lukaskronus/mpv-winbuild/actions)
[![releases](https://img.shields.io/github/v/release/lukaskronus/mpv-winbuild)](https://github.com/lukaskronus/mpv-winbuild/releases)
[![downloads](https://img.shields.io/github/downloads/lukaskronus/mpv-winbuild/total)](https://github.com/lukaskronus/mpv-winbuild/releases)
